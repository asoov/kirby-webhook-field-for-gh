...
Kirby::plugin('pju/webhook-field', [
    'options' => [
        ...
        'labels' => [
            ...
            'success' => [
                'name' => 'Die Seite wurde veröffentlicht.',
                'cta' => 'Erneut veröffentlichen',
                'text' => 'Deployment dauert ca. 3-10 Minuten. Letztes Deployment:',
            ],
            'error' => [
                'name' => 'Fehler',
                'cta' => 'Erneut deployen.',
                'text' => 'Der Deploymentserver konnte nicht erreicht werden.',
            ],
            'outdated' => [
